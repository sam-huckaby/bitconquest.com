...
<body class="antialiased">
    <div id="main_container" class="relative sm:flex sm:flex-col sm:justify-start sm:items-center min-h-screen bg-center bg-gray-100 dark:bg-gray-900 selection:bg-green-600 selection:text-white">
        ...
        <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
            <a href="{{ url('/features') }}" class="mr-4 font-semibold text-gray-400 hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Features</a>
            <a href="{{ url('/pricing') }}" class="mr-4 font-semibold text-gray-400 hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Pricing</a>
            @auth
            <a href="{{ url('/dashboard') }}" class="font-semibold text-gray-400 hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">My Dashboard</a>
            @else
