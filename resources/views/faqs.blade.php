    ...
    <div x-data="{ openTab: null }" class="pt-4 bg-gray-100 dark:bg-gray-900">
        <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0">
            ...
            <div class="w-full sm:max-w-2xl mt-6 p-6 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg prose dark:prose-invert">
                ...
                <!-- Accordion item 1 -->
                <div class="mt-2">
                    <button @click="openTab = openTab === 1 ? null : 1" class="flex flex-row justify-start items-center w-full h-8 text-xl font-bold">
                        Why does my domain say it is "Pending DNS Verification"?
                        <x-bi-chevron-right x-show="openTab !== 1" class="ml-4" />
                        <x-bi-chevron-down x-cloak x-show="openTab === 1" class="ml-4" />
                    </button>
                ...
                <!-- Accordion item 2 -->
                <div class="mt-2">
                    <button @click="openTab = openTab === 2 ? null : 2" class="flex flex-row justify-start items-center w-full h-8 mt-4 text-xl font-bold">
                        Why do you need to verify my domains?
                        <x-bi-chevron-right x-show="openTab !== 2" class="ml-4" />
                        <x-bi-chevron-down x-cloak x-show="openTab === 2" class="ml-4" />
                    </button>
                ...
                <!-- Accordion item 3 -->
                <div class="mt-2">
                    <button @click="openTab = openTab === 3 ? null : 3" class="flex flex-row justify-start items-center w-full h-8 mt-4 text-xl font-bold">
                        Why are we only able to log in via GitHub?
                        <x-bi-chevron-right x-show="openTab !== 3" class="ml-4" />
                        <x-bi-chevron-down x-cloak x-show="openTab === 3" class="ml-4" />
                    </button>
